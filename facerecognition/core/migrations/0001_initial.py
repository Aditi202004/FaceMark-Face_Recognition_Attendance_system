    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.classes')),
                ('date', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.date')),
